<template>
  <header class="header" :class="{
    'theme-dark': themeStore.isThemeDark && !headerStore.isCollapsed,
    'collapsed': headerStore.isCollapsed,
    'sticky': headerStore.isSticky
  }">
    ...
    <div class="header-container header-tools">
      <div class="content">
        ...
        <div class="tools-wrap">
          ...
          <div class="search">
            <n-input-group>
              <n-select class="search-select" style="background: transparent;" v-model:value="searchSelectValueRef"
                :options="searchSelectOptions" :consistent-menu-width="false" size="large" />
              <n-auto-complete v-model:value="searchInputValueRef" :input-props="{ autocomplete: 'disabled' }"
                :options="searchInputOptions" style="width: 350px; min-width: 350px;" size="large"
                placeholder="Search..." />
    ...
    <div class="header-container header-nav">
      <div class="content">
        <ul class="topnav">
          <RouterLink v-for="(item, index) in topnavList" :key="index" :to="item.path" custom
            v-slot="{ href, route, isActive, isExactActive }">
            <n-dropdown :options="item.children" size="huge">
              <li class="topnav-item" :class="{ 'topnav-item_active': isActive }">
